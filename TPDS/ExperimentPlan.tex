...
\begin{figure*}[ht!]
	\centering
	\mbox{
		\subfigure[\label{subfig:caidaflowmonitoring}]{\includegraphics[width=0.5\linewidth]{figures/exp84498/xdc1}}
		\subfigure[\label{subfig:campusnetworkflowmonitoring}]{\includegraphics[width=0.5\linewidth]{figures/exp84498/xdc2}}
	}
	\mbox{
		\subfigure[\label{subfig:hgcflowmonitoring}]{\includegraphics[width=0.5\linewidth]{figures/exp84498/xdc3}}
		\subfigure[\label{subfig:telecomflowmonitoring}]{\includegraphics[width=0.5\linewidth]{figures/exp84498/xdc4}}
	}
	\caption{当$x$分别取0.8, 0.85, 0.9, 0.95时四个trace文件的$x$分布系数变化情况。}
	\label{fig:x_distribution_coefficient}
\end{figure*}
...
\begin{figure*}[ht!]
	\centering
	\mbox{
		\subfigure[\label{subfig:caida_hh_are}]{\includegraphics[width=0.5\linewidth]{figures/exp84501/hh_are_3}}
		\subfigure[\label{subfig:caida_hh_f1score}]{\includegraphics[width=0.5\linewidth]{figures/exp84501/hh_f1score_3}}
	}
	\mbox{
		\subfigure[\label{subfig:caida_n_exports}]{\includegraphics[width=0.5\linewidth]{figures/exp84501/plr_3}}
	}
...
\begin{figure*}[ht!]
	\centering
	\mbox{
		\subfigure[\label{subfig:caida_hh_are_thresh}]{\includegraphics[width=0.5\linewidth]{figures/exp84503/hh_are}}
		\subfigure[\label{subfig:caida_hh_f1score_thresh}]{\includegraphics[width=0.5\linewidth]{figures/exp84503/hh_f1score}}
	}
...
\begin{algorithm}[ht!]
	...
	\begin{algorithmic}[1]
		\State{$min \gets \infty, max \gets 0, idx_{min} \gets -1, idx_{max}\gets -1, \gamma\gets 5$}
		...
		\If{${\mathbf A}[idx] == [0, 0]$}
		\State{${\mathbf A}[idx] \gets [digest_2, 1]$, ${\mathbf B}[idx]\gets max\%2^8$}
		...
		\ElsIf{$temp \ge \gamma~and~max\%2^8 == {\mathbf B}[idx]$}
		\State{$export(p.flowID), {\mathbf A}[idx]\gets [0, 0]$}
		\State{$promote(idx_{max}, digest1, temp)$}
		\Else
